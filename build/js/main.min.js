...
require("./modules/init-swipers");
require("./modules/init-video");
// ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/init-swipers":9,"./modules/init-video":10,"./modules/modals/init-modals":11,"./modules/tabs/tabs":13,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
exports.swiperStuff = exports.swiperFeedback = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var swiperStuff = new _swiper.default('.swiper--staff', {
  loop: true,
...
exports.swiperStuff = swiperStuff;
var swiperFeedback = new _swiper.default('.swiper--feedback ', {
  initialSlide: 0,
  slidesPerView: 1,
  slidesPerGroup: 1,
  spaceBetween: 30,
...
var container = video.querySelector('.video__container');
var image = video.querySelector('.video__image');
var createIframe = function createIframe(parent) {
...
button.addEventListener('click', function () {
  if (video && container) {
    ...
    var newIframe = createIframe(container);
